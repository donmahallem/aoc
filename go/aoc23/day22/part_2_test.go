...
func TestPart2(t *testing.T) {
	...
	t.Run("test real data", func(t *testing.T) {
		result, ok := test_utils.TestFullDataForDate(t, 23, 22, day22.Part2)
		if !ok || result != 98431 {
			t.Errorf(`Expected %d to be %d`, result, 98431)
		}
	})
}
...
func BenchmarkPart2(b *testing.B) {
	...
	b.Run("benchmark full data", func(b *testing.B) {
		test_utils.BenchmarkFullDataForDate(b, 23, 22, day22.Part2)
	})
}

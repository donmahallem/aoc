...
class AocYear24Day12_Field(unittest.TestCase):
    ...
    def test_parseInput_simple(self):
        ...
        self.assertEqual(f.data,[bytearray(b'AAA'), bytearray(b'BBB'), bytearray(b'CCB')])
    ...
    def test_collectIslands_simple(self):
        ...
        self.assertEqual(len(islands),3,f"Expected 3 islands, got {len(islands)}\n{islands}")
        self.assertEqual(islands[0],{(0,0),(0,1),(0,2)},f"Expected first island to be {(0,0),(0,1),(0,2)}, got {islands[0]}")
    ...
    def test_collectIslands_edges(self):
        ...
        f = _Field.parse_input(f_obj)
        islands = f.collect_islands()
        self.assertEqual(len(islands),6,f"Expected 6 islands, got {len(islands)}\n{islands}")

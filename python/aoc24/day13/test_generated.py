...
class Test2024Day13Part01(unittest.TestCase):
    ...
    @unittest.skipUnless(os.path.exists("data/samples/24/13_sample.txt"), "Test data file not found")
    def test_sample(self):
        with open("data/samples/24/13_sample.txt") as f:
            result = Part1(f)
            self.assertEqual(result, 480)

    @unittest.skipUnless(os.path.exists("data/full/24/13.txt"), "Test data file not found")

...
def Part2(input: typing.TextIO) -> int:
    ...
    @lru_cache()
    def dfs(currentNode: str,targetNode:str,exitOnDac: bool=False,exitOnFft:bool=False) -> int:
    ...
    path1 = dfs("svr", "dac", False, True) * dfs("dac", "fft", False, False) * dfs("fft", "out", False, False)
    path2 = dfs("svr", "fft", True, False) * dfs("fft", "dac", False, False) * dfs("dac", "out", False, False)
